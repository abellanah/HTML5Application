            ...
            <ul>
                ...
                <li class="active has-sub open"><a href='#'><span>Configure Our Menu</span></a>
                    <ul style="display: block;">
                        <li class='last'><a href='<?php echo Yii::app()->createUrl('management/menuindex'); ?>'><span>Categories</span></a></li>
                    </ul>
                </li>
                ...
                $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'buttons' => array(
                                'view' => array(
                                    'url' => 'Yii::app()->createUrl("management/viewcategory",array("id"=>$data->category_id))',
                                ),
                                'delete' => array(
                                    'url' => 'Yii::app()->createUrl("management/deletecategory",array("id"=>$data->category_id))',
                                ),
                            )
                        ),
                    ),
