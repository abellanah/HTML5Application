...
class Order extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('order_customer_id, order_quantity', 'required'),
			array('order_customer_id, order_item_id, order_quantity', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('order_id, order_customer_id, order_item_id, order_quantity', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'orderItem' => array(self::BELONGS_TO, 'Item', 'order_item_id'),
		);
	}
