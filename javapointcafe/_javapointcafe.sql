...
INSERT INTO `category` VALUES (3,'Dinner'),(1,'Drinks'),(4,'Lunch'),(2,'Snacks'),(8,'test');
...
INSERT INTO `customer` VALUES (1,'wilson sasam','wilson.sasam@gmail.com','03265988475','00:00:00','rwqrwqrrwrc cqw',0,294.5,'1231','0000-00-00 00:00:00',0),(2,'lovella tan','lovellamarietan@gmail.com','03265984115','00:00:00','ccwdwr  qdqwdewq  dwqed',1,50,'3123','0000-00-00 00:00:00',0);
...
CREATE TABLE `item` (
  ...
  CONSTRAINT `item_subcategory_id` FOREIGN KEY (`subcategory_id`) REFERENCES `subcategory` (`subcategory_id`) ON DELETE SET NULL ON UPDATE SET NULL
...
INSERT INTO `item` VALUES (1,'Big Mac','default.png',10,5),(2,'Sisig','default.png',22.25,6),(3,'Espresso','default.png',5.5,1),(6,'boom clap','6.png',12,7),(9,'test2','default.png',12,7),(12,'test234','default.jpg',234,NULL),(13,'345','default.jpg',345,NULL),(14,'456','default.jpg',456,NULL),(15,'987','default.jpg',987,NULL),(16,'876','default.jpg',876,NULL),(17,'ttt','default.jpg',22,NULL),(18,'rr','default.jpg',32,NULL),(19,'Century Tuna','default.png',23,10),(20,'teat','default.png',123,18),(21,'noimage85','21.jpg',123,7);
...
INSERT INTO `order` VALUES (1,1,1,15),(2,1,2,6),(17,2,1,5),(18,1,3,2);
...
INSERT INTO `subcategory` VALUES (1,1,'Coffee'),(2,1,'Milk'),(3,1,'Juice'),(4,2,'Appetizer'),(5,2,'Burger'),(6,2,'Rice'),(7,3,'Carbonara'),(8,1,'Soda'),(9,4,'Spaghetti'),(10,3,'Tuna Paella'),(11,3,'Longanissa'),(18,1,'Cola');
...
CREATE TABLE `user` (
  ...
  `user_type` enum('Admin','Sales') NOT NULL DEFAULT 'Admin',
...
INSERT INTO `user` VALUES (1,'admin123','31e2356f591f8ca34b19ae8c0e33dd71','Admin','Admin',1,NULL,NULL,NULL,NULL),(4,'Admin','b18cc9c663911ad97d0b2621b46d176b','AdminAdmin','Admin',1,NULL,NULL,NULL,NULL),(5,'Admin1234','31e2356f591f8ca34b19ae8c0e33dd71','Adminpassword','Admin',1,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2015-05-08 22:00:55
