    ...
    <div id="page-content-wrapper">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <strong>Configure Our Menu</strong>
                ...
                <div class="gallery">
                    <ul>
                        <li class="wow bounceIn" data-wow-delay="0.5s">
                            <a href="#about"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/r11.jpg" alt=""/></a>
                            <h3>Indian Recipes</h3>
                        </li>
                        <li class="wow bounceIn" data-wow-delay="0.5s">
                            <a href="images/r22.jpg"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/r22.jpg"/></a>
                            <h3>Mexican Roti</h3>
                        </li>
                        <li class="wow bounceIn" data-wow-delay="0.5s">
                            <a href="images/r33.jpg"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/r33.jpg"/></a>
                            <h3>Japanese Rolls</h3>
                        </li>
                        <li class="last wow bounceIn" data-wow-delay="0.5s">
                            <a href="images/r44.jpg"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/r44.jpg"/></a>
                            <h3>Chicken Recipes</h3>
                        </li>				 
                        <li class="wow bounceIn" data-wow-delay="0.5s">
                            <a href="images/r55.jpg"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/r55.jpg"/></a>
                            <h3>Mix Salad</h3>
                        </li>
                        <li class="wow bounceIn" data-wow-delay="0.5s">
                            <a href="images/r66.jpg"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/r66.jpg"/></a>
                            <h3>Vegiterian</h3>
                        </li>
                        <li class="wow bounceIn" data-wow-delay="0.5s">
                            <a href="images/r77.jpg"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/r77.jpg"/></a>
                            <h3>Spicy Pizza</h3>
                        </li>
                        <li class="last wow bounceIn" data-wow-delay="0.5s">
                            <a class='gallery2' href="images/r11.jpg"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/r11.jpg"/></a>
                            <h3>Indian Recipes</h3>
                        </li>					
                    </ul>
