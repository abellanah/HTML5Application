 ...
 * @property string $item_desctiption
...
class Item extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('item_desctiption, item_image, item_price, subcategory_id', 'required'),
			array('subcategory_id', 'numerical', 'integerOnly'=>true),
			array('item_price', 'numerical'),
			array('item_desctiption', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('item_id, item_desctiption, item_image, item_price, subcategory_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			'item_id' => 'Item',
			'item_desctiption' => 'Item Desctiption',
	...
	public function search()
	{
		...
		$criteria->compare('item_desctiption',$this->item_desctiption,true);
